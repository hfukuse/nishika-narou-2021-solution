...
以上を踏まえるとブックマーク度が0と予測された場合99.58%以上の作品がブックマーク数が0-9です。  
ブックマーク度が1と予測された場合96.95%の作品がブックマーク数が0-99です。  
ブックマーク度が2と予測された場合95.49%以上の作品がブックマーク数が10-999です。  
ブックマーク度が3と予測された場合97.89%以上の作品がブックマーク数が10-です。  
ブックマーク度が4と予測された場合80%の作品がブックマーク数が1000-です。  
# 参考  
1)CLRP-Pretrain  
